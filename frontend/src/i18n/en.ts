export const en = {
  ...
  app: {
    ...
    sidebar: {
      ...
      // PR 079 nav (sentence case, per the design language).
      today: "Today",
    ...
    today: {
      ...
      floorRegionLabel: "Floors",
      viewFullFloor: "View full floor",
      nearYouTitle: "Near you",
      nobodyYet: "Nobody yet — be the first in.",
      justYouSoFar: "It's just you so far — nobody else in yet.",
      mapAriaLabel: "Floor overview for the selected day",
      youShort: "You",
      moreInOffice: "+{count} more in the office",
      youreAtDesk: "You're at {desk}",
      youreRemote: "You're remote on {day}",
      bookForDay: "Book for {day} · {count} free",
      weekTitle: "Your week",
      weekHint: "tap a day to preview it above",
      statusRemote: "Remote",
      statusBook: "+ Book",
      planTomorrowTitle: "The office day is winding down",
      planTomorrowBody: "Plan tomorrow — grab your usual desk for the morning.",
      planTomorrowCta: "Plan tomorrow",
      welcomeTitle: "Welcome to WorkspaceCanvas",
      welcomeBody: "Pick your first desk and your Today screen will fill in from there.",
      welcomeCta: "Pick your first desk",
      linkTeamsNudge: "Book from Microsoft Teams too — connect your account.",
      linkTeamsCta: "Connect Teams",
      adminBannerTitle: "Finish setting up your workspace",
      adminBannerBody: "Add an office, a floor, and some desks so your team can book.",
      adminBannerCta: "Continue setup",
      adminBannerDismiss: "Dismiss",
      mapUnavailable: "The floor map is unavailable right now.",
      occupancyUnavailable: "Live occupancy is unavailable right now.",
      noFloors: "This office has no published floors yet.",
      bookThisDay: "Book a desk",
      inOffice: "{count} in the office",
    },
    dashboard: {
      greetingMorning: "Good morning",
      greetingAfternoon: "Good afternoon",
  ...
  rooms: {
    ...
    selectPrompt: "Select an office and floor to view meeting rooms.",
    // Role-aware empty states (mirror the desk page, room-worded).
    noOfficesAdminTitle: "No offices yet",
    noOfficesAdminDesc: "Create your first office to enable room booking.",
    noOfficesAdminAction: "Manage offices",
    noOfficesMemberTitle: "No offices available",
    noOfficesMemberDesc: "Your workspace has no offices set up yet. Contact your admin.",
    noFloorsAdminTitle: "No floors yet",
    noFloorsAdminDesc: "Add a floor to this office before booking rooms.",
    noFloorsAdminAction: "Manage floors",
    noFloorsMemberTitle: "No floors available",
    noFloorsMemberDesc: "This office has no floors set up yet. Contact your admin.",
    noRoomsTitle: "No meeting rooms",
    noRoomsAdminDesc:
      "No meeting rooms are enabled on this floor yet. Add one from the floor's layout by turning a room object into a bookable room.",
    noRoomsMemberDesc:
      "No meeting rooms are available to book on this floor yet. An admin needs to enable them.",
    loadingRooms: "Loading meeting rooms...",
    errorLoadingRooms: "Failed to load meeting rooms. Please try again.",
    errorLoadingBookings: "Failed to load room bookings. Please try again.",
    capacityLabel: "Capacity",
    roomUnavailable: "This room isn't available for booking right now.",
    // Timeline
    bookedTimesLabel: "Booked times",
    noBookingsYet: "No bookings yet — the day is free.",
    statusReserved: "Reserved",
    statusMine: "Your booking",
    // Slot picker
    ...
    cancelAction: "Cancel",
    cancelConfirmTitle: "Cancel this room booking?",
    cancelConfirmMessage: "This releases the room slot for others. You can't undo this.",
    cancelConfirmConfirm: "Cancel booking",
    cancelConfirmDismiss: "Keep booking",
  },
  linkChat: {
    title: "Link your chat account",
    prompt: "Connect this WorkspaceCanvas account to the chat app that showed you this link?",
    confirm: "Link account",
    cancel: "Cancel",
    linking: "Linking…",
    successTitle: "Account linked",
    successBody: "You can now use WorkspaceCanvas from chat as {email}.",
    done: "Done",
    expiredTitle: "Link expired",
    expiredBody: "This link expired. Start again from chat with the link command.",
    usedTitle: "Link already used",
    usedBody: "This link was already used. Start again from chat if you need a new one.",
    invalidTitle: "Link not valid",
    invalidBody: "This link isn't valid. Start again from chat with the link command.",
    errorTitle: "Something went wrong",
    errorBody: "We couldn't link your account. Please try again.",
    missingCode: "No link code was provided. Open the link from your chat message.",
  },
  common: {
