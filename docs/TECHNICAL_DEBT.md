...
*Last updated: 2026-06-02 — PR 051 final MVP polish; TD-042 resolved (Events route + ComingSoonPage removed; AppLayout layout route added so all protected pages share a single AppShell); PeoplePage h1 consistency fixed; MyBookingsPage i18n wired*
